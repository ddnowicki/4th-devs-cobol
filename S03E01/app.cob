      ...
      *> -- JSON escape I/O --
       01  WS-ESC-IN               PIC X(2000).
       01  WS-ESC-OUT              PIC X(4000).
      ...
      *> -- Phase 2: Sensor file processing --
      ...
      *> -- Sensor values (string for parsing) --
      ...
      *> -- Flagged file IDs (Phase 2) --
       01  WS-MAX-FLAGS            PIC 9(5) VALUE 15000.
       01  WS-FLAG-COUNT           PIC 9(5) VALUE 0.
       01  WS-FLAG-IDS.
           05 WS-FLAG-ID OCCURS 15000 TIMES
                                   PIC X(20).

      *> -- Valid files with notes (Phase 2->3) --
       01  WS-MAX-VALID            PIC 9(5) VALUE 15000.
      ...
      *> -- Unique notes table (Phase 3) --
       01  WS-MAX-UNIQ             PIC 9(5) VALUE 2000.
      ...
      *> -- Combined flags for final submit --
      ...
      *> -- Sensor type part counter --
       01  WS-PART-COUNT           PIC 9(2).

      *> -- Numeric file iteration --
